...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->knob1 = (gcnew Iocomp::Instrumentation::Standard::Knob());
			...
			this->edit_int->Location = System::Drawing::Point(380, 291);
			...
			this->label3->Location = System::Drawing::Point(324, 300);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(50, 25);
			this->label3->TabIndex = 25;
			this->label3->Text = L"角度";
			...
			this->label8->Location = System::Drawing::Point(454, 291);
			...
			this->knob1->Body->Radius = 74;
			this->knob1->Body->Style = Iocomp::Types::KnobBodyStyle::RaisedEdge;
			this->knob1->Location = System::Drawing::Point(273, 83);
			this->knob1->Name = L"knob1";
			this->knob1->Pointer->Margin = 7;
			this->knob1->Pointer->Size = 13;
			this->knob1->Pointer->Style = Iocomp::Types::PointerStyleKnob::Triangle;
			this->knob1->ScaleDisplay->GeneratorStyle = Iocomp::Types::ScaleGeneratorStyle::Fixed;
			this->knob1->ScaleRange->AngleMin = 180;
			this->knob1->ScaleRange->AngleSpan = 180;
			this->knob1->ScaleRange->Span = 180;
			this->knob1->Size = System::Drawing::Size(285, 202);
			this->knob1->TabIndex = 36;
			this->knob1->Value->AsDouble = 20;
			this->knob1->ValueChanged += gcnew Iocomp::Delegates::ValueDoubleEventHandler(this, &Form1::knob1_ValueChanged);
...
private: System::Void timer100ms_Tick(System::Object^  sender, System::EventArgs^  e) {
			...
			// int temp = System::Int32::Parse()
			 ...
			 if(temp != modbus->modbus_Addt.actuator_angle)//数据有改变。发送数据
			 {
				modbus->modbus_Addt.actuator_angle = temp;
				modbus->SendWriteCommand(FUN_WRITEREG,0,1,&(modbus->modbus_Addt.actuator_angle));
				SendData();
				return;
			 }
			 //发送读取所有值指令
			 //刷新数据
			 modbus->SendReadCommand(4,0,1);
			 SendData();
		 }
...
private: System::Void knob1_ValueChanged(System::Object^  sender, Iocomp::Classes::ValueDoubleEventArgs^  e) {
			 edit_int->Value = knob1->Value->AsInteger;
		 }
};
}
