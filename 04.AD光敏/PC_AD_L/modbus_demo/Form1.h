...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label5->Location = System::Drawing::Point(297, 6);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(216, 48);
			this->label5->TabIndex = 19;
			this->label5->Text = L"光敏感应";
...
private: System::Void timer100ms_Tick(System::Object^  sender, System::EventArgs^  e) {
			 //读取公共区，刷新显示值
			double Light_u = ((double)(modbus->modbus_Addt.AD_Light)/255)*(edit_ref->Value->AsDouble);
			Light_u = Math::Round(Light_u,2);//取两位小数
			//限幅
			if(Light_u > edit_ref->Value->AsDouble) Light_u = edit_ref->Value->AsDouble;
			if(Light_u < 0) Light_u = 0;
			ang_u->Value = Light_u;
			edit_u->Value = Light_u;
			plot_U->Channels[0]->AddXY(System::DateTime::Now,Light_u);//绘图
			 //发送读取所有值指令
			 //刷新数据
