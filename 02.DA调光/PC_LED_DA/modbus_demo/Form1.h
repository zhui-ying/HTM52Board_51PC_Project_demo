...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(108, 358);
			...
			this->label2->Location = System::Drawing::Point(313, 358);
			...
			this->com_port->Items->AddRange(gcnew cli::array< System::Object^  >(7) {L"COM1", L"COM2", L"COM3", L"COM4", L"COM5", L"COM6", 
				L"COM7"});
			this->com_port->Location = System::Drawing::Point(173, 353);
			...
			this->com_bps->Items->AddRange(gcnew cli::array< System::Object^  >(7) {L"4800", L"9600", L"14400", L"19200", L"28800", L"38400", 
				L"57600"});
			this->com_bps->Location = System::Drawing::Point(388, 355);
			...
			// btn_open
			// 
			this->btn_open->Location = System::Drawing::Point(529, 351);
			...
			this->label5->Size = System::Drawing::Size(292, 48);
			this->label5->TabIndex = 19;
			this->label5->Text = L"LED灯AD调光";
			...
			this->linkLabel1->Location = System::Drawing::Point(459, 393);
			...
			this->label6->Font = (gcnew System::Drawing::Font(L"微软雅黑", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(134)));
			this->label6->Location = System::Drawing::Point(373, 393);
			...
			this->slider1->Location = System::Drawing::Point(130, 135);
			...
			this->slider1->ScaleRange->Min = 100;
			...
			this->slider1->Value->AsDouble = 150;
			this->slider1->Value->Max = 200;
			this->slider1->Value->Min = 100;
			...
			this->edit_int->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(255)), static_cast<System::Int32>(static_cast<System::Byte>(0)), 
				static_cast<System::Int32>(static_cast<System::Byte>(0)));
			this->edit_int->Location = System::Drawing::Point(340, 222);
			this->edit_int->MaxLength = 255;
			this->edit_int->Name = L"edit_int";
			this->edit_int->ReadOnly = true;
			this->edit_int->Size = System::Drawing::Size(80, 34);
			this->edit_int->TabIndex = 24;
			this->edit_int->Value->AsString = L"150";
			this->edit_int->LoadingEnd();
			// 
			// label3
			// 
			this->label3->AutoSize = true;
			this->label3->Location = System::Drawing::Point(276, 231);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(58, 25);
			this->label3->TabIndex = 25;
			this->label3->Text = L"DA值";
			this->label3->UseMnemonic = false;
			// 
			// label4
			// 
			this->label4->AutoSize = true;
			this->label4->Location = System::Drawing::Point(76, 107);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(50, 25);
			this->label4->TabIndex = 26;
			this->label4->Text = L"光弱";
			this->label4->UseMnemonic = false;
			// 
			// label7
			// 
			this->label7->AutoSize = true;
			this->label7->Location = System::Drawing::Point(604, 107);
			this->label7->Name = L"label7";
			this->label7->Size = System::Drawing::Size(50, 25);
			this->label7->TabIndex = 27;
			this->label7->Text = L"光强";
			...
			this->panel1->Size = System::Drawing::Size(747, 58);
			this->panel1->TabIndex = 28;
			// 
			// panel2
			// 
			this->panel2->Dock = System::Windows::Forms::DockStyle::Bottom;
			this->panel2->Location = System::Drawing::Point(0, 340);
			this->panel2->Name = L"panel2";
			this->panel2->Size = System::Drawing::Size(747, 83);
			...
			this->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(0)), static_cast<System::Int32>(static_cast<System::Byte>(192)), 
				static_cast<System::Int32>(static_cast<System::Byte>(0)));
			this->ClientSize = System::Drawing::Size(747, 423);
...
private: System::Void timer100ms_Tick(System::Object^  sender, System::EventArgs^  e) {
			...
			// int temp = System::Int32::Parse()
			 ...
			 if(temp != modbus->modbus_Addt.DA_LED)//数据有改变。发送数据
			 {
				modbus->modbus_Addt.DA_LED = temp;
				modbus->SendWriteCommand(FUN_WRITEREG,4,1,&(modbus->modbus_Addt.DA_LED));
				SendData();
				return;
			 }
			 //发送读取所有值指令
